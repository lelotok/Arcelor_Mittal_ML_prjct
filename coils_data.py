...
coils = os.listdir("../SignalExport")

for coil in coils:

    with open("../SignalExport/" + str(coil), "r") as read_file:
    ...
    if captures != None:
        ...
        with open("../new_coils_data/" + str(coil), "w") as write_file:
            ...
            os.remove("../SignalExport/" + str(coil))
